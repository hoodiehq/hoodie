module.exports = function () {
  ...
  o.api.clear = sinon.stub();
  o.api.isBootstrapping = sinon.stub();
  o.api.isPersistent = sinon.stub();
  o.api.decoratePromises = sinon.stub();
  o.api.subscribeToOutsideEvents = sinon.stub();
  o.api.bootstrapDirtyObjects = sinon.stub();
  o.api.patchIfNotPersistant = sinon.stub();
  ...
  o.api.changedObjects = sinon.stub().returns([]);
