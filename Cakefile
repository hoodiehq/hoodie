...
task 'build', 'build hoodie-client.min.js', -> 
  ...
  js_code = ''
  build = spawn 'cat', ['compiled/src/events.js', 'compiled/src/hoodie.js', 'compiled/src/hoodie/account.js', 'compiled/src/hoodie/config.js', 'compiled/src/hoodie/email.js', 'compiled/src/hoodie/errors.js', 'compiled/src/hoodie/remote_store.js', 'compiled/src/hoodie/local_store.js', 'compiled/src/hoodie/user_store.js']
