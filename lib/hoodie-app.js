...
// register with local-tld
ltld.add(package_json.name, port);
ltld.add("couch." + package_json.name, port + 1);
// ltld.add("admin." + package_json.name, port + 2);
