...
exports.register = function (plugin, options, next) {
  var mapProxyPath = internals.mapProxyPath.bind(null, options.app.couch);
  var getHoodiePath = internals.getHoodiePath.bind(null, options);
  var handlePluginRequest = internals.handlePluginRequest.bind(null, options);
