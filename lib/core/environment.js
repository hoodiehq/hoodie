...
exports.getConfig = function (platform, env, project_dir, argv) {
  ...
  var cfg = {
    ...
    hoodie: {
      app_path: path.resolve(project_dir),
      data_path: path.resolve(project_dir, 'data')
    },
  ...
  cfg.www_link = function () {
    return cfg.local_tld ? cfg.www_local_url
      : 'http://' + cfg.host + ':' + cfg.www_port;
  };
  cfg.admin_link = function () {
    return cfg.local_tld ? cfg.admin_local_url
