...
exports.getConfig = function (platform, env, project_dir, argv) {
  ...
  var pkgfile = require(__dirname + '/../../package.json');
  ...
  var cfg = {
    ...
    www_root: path.resolve(__dirname, '../../../../www'),
    admin_root: path.resolve(__dirname, '../../node_modules/hoodie-pocket/www'),
    ...
    www_link: function () {
      return this.local_tld
        ? this.www_local_url
        : 'http://' + this.host + ':' + this.www_port;
    },
    admin_port: ports.getPort(this.id + '-admin'),
    admin_link: function () {
      return this.local_tld
        ? this.admin_local_url
        : 'http://' + this.host + ':' + this.admin_port;
    },
