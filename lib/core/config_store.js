...
exports.read = function (env_config, callback) {
  fs.readFile(exports.path(env_config), function (err, data) {
    if (err) {
...
exports.write = function (env_config, obj, callback) {
  ...
  var config_path = exports.path(env_config)
  async.series([
    async.apply(fs.writeFile, config_path + '.tmp', data),
    async.apply(fs.rename, config_path + '.tmp', config_path)
  ],
    callback)
}
