...
module.exports = function (config, callback) {
  ...
  if (hashesChanged(hashes, oldhashes)) {
    ...
    bundler.bundle(function (err, buffer) {
      ...
      // TODO: add timestamp to bundle
      // TODO: store appropriate cache/build-time info in config object
      // TODO: set appropriate headers when responding from cache
    ...
    config.hoodiejs = fs.readFileSync(bundleCachePath);
    return callback();
  }
