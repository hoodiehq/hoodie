...
internals.generatedConfig = function generatedConfig (config) {
...
internals.checkVendor = function checkVendor (config, couch, callback) {
...
internals.setConfig = function setConfig (couch, callback) {
  couch({
...
internals.getConfig = function getConfig (couch, callback) {
  couch({
...
internals.getAdmins = function getAdmins (couch, callback) {
  couch({
    url: '/_config/admins'
  }, function (err, res, data) {
    if (err || (res && res.statusCode !== 200)) {
