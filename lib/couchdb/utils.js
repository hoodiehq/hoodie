...
exports.updateCouchCredentials = function (env_config, callback) {
  log.silly('Checking if provided database exports.credentials work')
  ...
  exports.checkCouchCredentials(env_config, function (err, admin) {
    ...
    if (admin) {
      log.verbose('Provided database exports.credentials work')
      return callback()
    }
...
exports.promptCouchCredentials = function (callback) {
  console.log('Please enter your database _admin exports.credentials:')
  prmpt.get({
    properties: {
      name: {
