...
exports.startMultiCouch = function (env_config, callback) {
  ...
  var couch_cfg = {
    ...
    prefix: env_config.hoodie.app_path,
...
exports.pollCouch = function (env_config, callback) {
  ...
  var logfiles = [
    '\t' + path.resolve(env_config.hoodie.app_path, 'couch.stderr'),
    '\t' + path.resolve(env_config.hoodie.app_path, 'couch.stdout'),
    '\t' + path.resolve(env_config.hoodie.app_path, 'couch.log')
  ];
