...
exports.startMultiCouch = function (config, callback) {
  ...
  var couch_cfg = {
    ...
    prefix: config.hoodie.data_path,
...
exports.pollCouch = function (config, callback) {
  ...
  var logfiles = [
    '\t' + path.resolve(config.hoodie.data_path, 'couch.stderr'),
    '\t' + path.resolve(config.hoodie.data_path, 'couch.stdout'),
    '\t' + path.resolve(config.hoodie.data_path, 'couch.log')
  ];
