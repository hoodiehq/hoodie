...
exports.createClient = function (config, password, callback) {
    exports.createCouchClient(config, password, function (err, couch) {
...
exports.createCouchClient = function (config, password, callback) {
    var couch = {};

    // add auth details to couch url
    couch.base_url = url.parse(config.couch.url);
    couch.base_url.auth = 'admin:' + encodeURIComponent(password);
