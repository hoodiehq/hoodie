...
describe("Hoodie.Config", function() {
  ...
  describe(".set(key, value)", function() {
    beforeEach(function() {
      return spyOn(this.hoodie.my.localStore, "update");
    });
    it("should save a $config with key: value", function() {
      this.config.set('funky', 'fresh');
      return expect(this.hoodie.my.localStore.update).wasCalledWith('$config', 'hoodie', {
        funky: 'fresh'
      }, {
        silent: false
      });
  ...
  describe(".get(key)", function() {
    beforeEach(function() {
      spyOn(this.hoodie.my.localStore, "load").andReturn(this.hoodie.defer().resolve({
        funky: 'fresh'
      }));
      return this.config = new Hoodie.Config(this.hoodie);
    });
  ...
  return describe(".remove(key)", function() {
    beforeEach(function() {
      return spyOn(this.hoodie.my.localStore, "update").andReturn('promise');
    });
