  ...
  return SharingInstance = (function() {
    ...
    SharingInstance.prototype.attributes = function(update) {
      if (update) {
        ...
        update.password || (update.password = this.id);
        this.id = update.id, this.filters = update.filters, this["private"] = update["private"], this.invitees = update.invitees, this.continuous = update.continuous, this.collaborative = update.collaborative, this.password = update.password;
      }
      return {
