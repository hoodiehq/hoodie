...
Hoodie.RemoteStore = (function() {
  ...
  RemoteStore.prototype.save = function(type, id, object) {
    return console.log.apply(console, [".save() not yet implemented"].concat(__slice.call(arguments)));
  };

  RemoteStore.prototype.update = function(new_properties) {
    return console.log.apply(console, [".update() not yet implemented"].concat(__slice.call(arguments)));
  };

  RemoteStore.prototype.updateAll = function(type, new_properties) {
    return console.log.apply(console, [".updateAll() not yet implemented"].concat(__slice.call(arguments)));
  };
